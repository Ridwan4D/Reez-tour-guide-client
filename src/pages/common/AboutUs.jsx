...
const AboutUs = () => {
  return (
    <div className="mt-5 md:mt-0 space-y-5 dark:text-gray-100">
      <Helmet>
        <title>About- Reez Tour Guide</title>
      </Helmet>
      <div className=" text-center ">
        <h3 className="text-2xl md:text-4xl font-bold animate__animated animate__fadeInUp">
          About Us
        </h3>
        <p className="text-lg md:text-2xl font-bold mb-2 md:mb-5 underline text-gray-500">
          Welcome to <span className="text-[#10b981]">Reez Tour Guide</span>
        </p>
        <p className="text-sm md:text-base text-start text-gray-600">
      ...
      <div>
        <h3 className="text-xl md:text-3xl text-[#10b981] font-semibold underline">
          Our Story
        </h3>

...
const AllPackages = () => {
  ...
  return (
    <div>
      ...
      <h2 className="mb-4 text-2xl px-14 md:px-1 border-b-2 pt-3 md:pt-0 pb-2 border-[#10b981] bg-slate-400 md:bg-white md:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white text-center">
        All Packages of{" "}
